...
class EntityMappingAPI:
    ...
    def __init__(
        ...
        Args:
            ...
            scoring_mode: Scoring mode ('llm', 'local_llm', 'hybrid', 'semantic_only')
        ...
        # Validation module - 로컬 LLM 지원
        use_local_llm = scoring_mode.lower() == "local_llm"
    ...
    def map_entity(self, entity_input: EntityInput) -> Optional[List[MappingResult]]:
        ...
        try:
            ...
            # Set debug variables for best result
            if all_results:
    ...
    def _map_entity_for_domain(
        ...
        try:
            ...
            if not is_valid:
                ...
                if validated:
                    logger.info(f"Alternative found: {validated['concept'].get('concept_name')}")
